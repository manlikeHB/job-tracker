...
if (interviewForm) interviewForm.addEventListener("submit", (e)=>{
    e.preventDefault();
    (0, _addInterviewDefault.default)();
});
// Edit job
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jb4Zk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = showPassword = (showPasswordBox, passwordInputs)=>{
    showPasswordBox.addEventListener("click", function() {
        if (passwordInputs) passwordInputs.forEach((n)=>{
            if (n.type === "password") n.setAttribute("type", "text");
            else n.setAttribute("type", "password");
        });
    });
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bZ6uq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = hamburgerMenu = (hamburger, navMenu)=>{
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alerts = require("./alerts");
exports.default = addInterview = async ()=>{
